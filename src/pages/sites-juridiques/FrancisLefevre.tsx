        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-slide-up">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground text-lg">
              Expert en droit fiscal et social
            </p>
          </div>
          ...
          <Card className="border-primary/30 bg-gradient-to-br from-primary/5 to-accent/5 p-8">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-foreground">À propos de Francis Lefebvre</h2>
                  <p className="text-muted-foreground">Référence en documentation fiscale et sociale</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Guides fiscaux et sociaux</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                    <span>Actualités fiscales</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                    <span>Analyses et commentaires</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                    <span>Outils pratiques et formulaires</span>
                  </li>
                </ul>
              </div>
