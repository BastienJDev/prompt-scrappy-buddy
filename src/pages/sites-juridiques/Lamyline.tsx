          ...
          <Card className="border-primary/30 bg-gradient-to-br from-primary/5 to-accent/5 p-8">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-foreground">À propos de Lamyline</h2>
                  <p className="text-muted-foreground">Expertise juridique spécialisée par domaine</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Collections spécialisées par matière</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                    <span>Formulaires et modèles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                    <span>Actualités et commentaires</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                    <span>Doctrine approfondie</span>
                  </li>
                </ul>
              </div>
              ...
              <Button 
                ...
                onClick={() => triggerAutoLogin('lamyline', SITE_CONFIGS.lamyline.startUrl)}
              >
